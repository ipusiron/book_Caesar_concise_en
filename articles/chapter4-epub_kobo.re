...
This ratio reveals how often each character appears in typical English text. See @<chap>{appendixA-epub_kobo} for detailed frequency tables.
...
//noindent
@<b>{Step 1}: Access the Index of Coincidence calculator at dCode.fr.
...
For example, if you calculate the index of coincidence using dCode.fr, you can confirm that the index of coincidence of the ciphertext is 8.2%. See @<img>{ic2}.
